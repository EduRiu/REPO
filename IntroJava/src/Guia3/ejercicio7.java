...
public class ejercicio7 {
    ...
    public static void main(String[] args) {
        ...
        Scanner lectura_i = new Scanner (System.in);
        String frase = " ";
        String salida = "&&&&&";
         ...
         while (!frase.equals(salida))
         {
            ...
            {              
              ...
              contadorI++;
                   ...
                   System.out.println("correctos " + contadorC + " incorrectos " + contadorI);
